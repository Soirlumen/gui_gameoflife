...
template <> constexpr inline auto game::qt_create_metaobjectdata<qt_meta_tag_ZN4gameE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'loadGame'
        QtMocHelpers::SlotData<void(const SQMatrix &, char)>(8, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 9, 10 }, { QMetaType::Char, 11 },
        }}),
        // Slot 'receiveMatrix'
        QtMocHelpers::SlotData<void(const QString &, char)>(12, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::QString, 10 }, { QMetaType::Char, 11 },
        }}),
    };
